          ...
          <div className="grid md:grid-cols-2 grid-cols-1 gap-4">
            <div className="column">
              ...
              <p className="leading-8">
                Welcome to <b>BookMyLook</b>, your ultimate destination for connecting with top-tier makeup artists at your fingertips. We are an innovative online platform designed to bring the best beauty professionals to your doorstep, making it easier than ever to find, book, and enjoy exceptional makeup services.
              </p>
              <ul className="columns-2 pl-0 mt-10">
                ...
                <li className="flex items-center mb-2"><CheckIcon className="w-5 h-5 bold mr-2 ctheme" />Draping</li>
              </ul>
              {/* our mission */}
              <div>
                <h4 className="ctheme font-semibold text-2xl mt-10 mb-3">Our Mission</h4>
                <p>
                  At BookMyLook, our mission is to revolutionize your beauty service experience. We aim to provide a seamless, convenient, and personalized journey for both clients and makeup artists. Leveraging technology, we strive to create a thriving community where beauty professionals can showcase their talents and clients can discover the perfect match for their needs.
                </p>
            ...
            <div className="column">
              <div className="relative flex justify-center items-center md:flex-col">
                <div className="relative md:absolute md:right-0 md:top-0">
                  <Image width={300} height={400} style={{ height: '300px', width: 'auto' }} alt="image" src="/images/services/5.jpg" />
                </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex md:flex-row flex-col">
            ...
            <div className="md:w-1/2 w-full pl-0 md:pl-4">
              ...
              <p className="mb-2 md:mb-7">
                Access a wide range of talented makeup artists in your area, all in one place. Our user-friendly platform allows you to browse profiles, view portfolios, read reviews, and book appointments at your convenience.
              </p>
              <p className="mb-2 md:mb-7">
                Choice: Whether you’re looking for a bridal makeup artist, a specialist for a glamorous event, or a professional for a casual outing, we’ve got you covered. Choose from a diverse selection of artists, each with unique skills and styles to suit your preferences.
              </p>
              <p className="mb-2 md:mb-7">
                <span className="font-bold">Quality :</span> We onboard only the best in the industry, ensuring every artist on our platform meets high standards of professionalism and expertise. Your satisfaction is our priority.
              </p>
              <p className="mb-2 md:mb-7">
                <span className="font-bold">Personalized :</span> Recommendations: Our platform suggests makeup artists based on your preferences and past experiences, ensuring you find the perfect match for every occasion.
              </p>
              <p>
                <span className="font-bold">Verified</span> Professionals: All makeup artists on <span className="font-bold">BookMyLook</span> undergo a thorough verification process, giving you peace of mind about the quality and safety of the services you receive.
              </p>
            </div>
          </div>
          <div className="w-full pt-3 md:pt-10">
            ...
            <ul className="pl-[25px] list-disc">
              ...
              <li className="mb-2 md:mb-7"><span className="font-bold">Community: </span> Join a supportive network of fellow makeup artists, where you can share experiences, tips, and opportunities.</li>
            </ul>
          </div>
        </div>
      </section>
